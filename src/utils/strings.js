...
export const ERROR1 = 'Oops! Something went wrong!';
export const ERROR2 = 'We are working on it.';
...
export const WHATSAPP_IS_NOT_INSTALLED_IN_YOUR_DEVICE = 'WhatsApp is not installed in your device';
export const PLEASE_INSTALL_WHATSAPP_TO_PERFORM_THIS_ACTION = 'Please install WhatsApp to perform this action';

export const PROFILE_SHARED_SUCCESSFULLY = 'Profile shared successfully';
